...
<head>
    ...
    <title>Visual Consultancy - Visual Tracking Tool</title>
  ...
  <section id="container" >
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><i class="fa fa-eye"></i>Visual<span>Tracker</span></a>
            <!--logo end-->
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <span class="message">
                                     Hi, We resolve the Defect at Project.
                                    </span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <span class="message">
                                        Hello, this is Visual Consultants.
                                    </span>
                                </a>
                            </li>
                            <li>
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="../public/img/profile-avatar.jpg" width="90" height="83" alt="">
                              </a>
                      ...
                      <section class="panel">
                          <div class="panel-body">
                                  <div class="text-center mbot30">
                                      ...
                                      <p class="t-info">This is a Timeline on Recent Project </p>
                                  </div>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <p><a href="#">RamaKrishan Added</a> One new Test Case To Project1 <span>                                                  </div>
                                              </div>
                                          </div>
                                      </article>
                                      <article class="timeline-item alt">
      ...
      <div class="sb-slidebar sb-right sb-style-overlay">
          <h5 class="side-title">Online Colleagues</h5>
          <ul class="quick-chat-list">
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="../public/img/chat-avatar2.jpg" class="media-object">
                      </a>
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="../public/img/chat-avatar.jpg" class="media-object">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="../public/img/pro-ac-1.png" class="media-object">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="../public/img/avatar1.jpg" class="media-object">
                      </a>
                      <div class="media-body">
              ...
              <li class="online">
                  <div class="media">
                      <a href="#" class="pull-left media-thumb">
                          <img alt="" src="../public/img/mail-avatar.jpg" class="media-object">
                      </a>
                      <div class="media-body">
                          <div class="media-status">
                              <span class=" badge bg-warning">7</span>
      ...
      <footer class="site-footer">
          <div class="text-center">
              2014 &copy; Visual Tracker by Visual Consultants.
              <a href="#" class="go-top">
